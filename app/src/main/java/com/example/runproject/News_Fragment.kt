...
class News_Fragment : Fragment() {
    ...
    private lateinit var newsadapter : adapter_news
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_news_, container, false)

        recyclerview = view.findViewById(R.id.news_fragment_rv)
        ...
        newsadapter = adapter_news(favlist)
...
//        adapter.setOnClickListener(object :adapter_music.OnClickListener{
